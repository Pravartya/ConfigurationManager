...
public class ConfigurationCache {
	...
	public ConfigurationCache(DynamoDBMapper mapper  ,Integer cacheTime ,String domain,String realm,String applicationName) {
		...
		try {
			...
			cache = CacheBuilder.newBuilder()
					.expireAfterAccess(cacheTime, TimeUnit.MINUTES)
					.build(loader);
